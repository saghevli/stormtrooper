...
phantomjs='/home/ec2-user/phantomjs-1.9.7/bin/phantomjs'
if [ "$4" = "y" ]
then
    ...
    do
        printf '%d of %d\n' $i $1
        $phantomjs phantom_get.js $2
        $phantomjs --proxy=127.0.0.1:8888 phantom_get.js $3
